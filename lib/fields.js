...
exports.FileField = FileField = new Class({
	...
	, hydrate: function( bundle, cb ){
		...
		value.pipe( out );
		return cb && cb( null, fpath );
	}
});

/**
 * that accepts and returns a simple path to a file
 * @class module:tastypie/fields.FilePathField
 * @extends module:tastypie/fields.ApiField
 * @param {Object} options
 * @param {Boolean} [options.stream=false]
 * @param {String} [options.root=os.tempDir()]
 * @param {String} [options.dir]
 */
exports.FilePathField = FilePathField = new Class({
	inherits: ApiField
	,options:{
		root:os.tmpDir(),
		dir:'uploads'
