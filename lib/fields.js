 ...
 * @param {Boolean} [options.null=false] true of the field should allow for a null vlaue
...
exports.DateField = DateField = new Class({
	...
	,convert: function convert( value ){
		...
		if( isString( value ) ){
			...
			if( !valid ){
				throw boom.create(400, util.format( "Invalid Date String for field %s: %s", this.options.name, value ) );
			}
