...
/**
 * Field class for handling arrays and comma separated strings
...
/**
 * Field for dealing with integer values
 * @class module:tastypie/fields.IntegerField
 * @extends module:tastypie/fields.ApiField
 */
...
/**
 * Field class for dealing with floating point numbers
...
/**
 * Field class for dealing with boolean values. Values are typecast before being forced to a boolean
 * @class module:tastypie/fields.BooleanField
 * @extends module:tastypie/fields.ApiField
 * borrows module:tastypie/fields.ApiField.options
 */
...
/**
 * No-Op Field class for returning plain objects
 * @class module:tastypie/fields.FileField
 * @extends module:tastypie/fields.ApiField
 * @param {Object} options
 ...
 */
exports.FileField = FileField = new Class({
	inherits: ApiField
	, options:{
		stream: false,
		root: os.tmpDir(),
	...
	, convert: function( value ){
		...
		this.emit('error', boom.create(500,"file destination unwriteable" ) );
	}
...
Object.defineProperties( exports,{
	...
	, file: {
		get: function( ){
			 ...
			 * @memberof module:tastypie/fields
			 * @property {Field} character short cut for the {@link module:tastypie/fields.FileFieldCharField|FileField} class
			 **/
			return FileField;
		}
	}
