 ...
 * @param {Number} status The http status code to set on the response
 **/
exports.switchProxy = redirect(306)
 ...
 * @param {Number} status The http status code to set on the response
 **/
exports.requestTimeout = function( res, data, type ){
 ...
 * @param {Number} status The http status code to set on the response
 **/
exports.unprocessableEntity = function( res, data, type ){
	return res(data || STATUS_CODES[ 422 ] ).code( 422 ).type( type );
};
 ...
 * @param {Number} status The http status code to set on the response
 **/
exports.serverError = function( res, data, type ){
 ...
 * @param {Number} status The http status code to set on the response
 **/
exports.badGateway = function( res, data, type ){
	return res(data || STATUS_CODES[ 502 ] ).code( 502 ).type( type );
};
