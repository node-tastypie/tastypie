...
Paginator = Class({
  ...
  , offset: function offset( ){
	  ...
	  var params = this.meta.req.params || {};
  ...
  , slice: function(limit, offset ){
	 ...
	 if( limit <=0 ){
	 	return this.meta.objects.slice( offset-1, this.meta.objects.length )
	 }

	 return this.meta.objects.slice( offset-1, ( offset-1 ) + limit )
  }
  , limit: function(){
	  var lmt;
  ...
  , uri: function uri( limit, offset ){
	  var values = clone(this.req.params || {});
