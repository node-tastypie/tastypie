...
Detail = new Class({
	...
	delete_detail: co.wrpa(function* delete_detail( bundle ){
	 ...
	 **/
	, get_detail:co.wrap(function* get_detail( bundle ){
...
var MyResource = new Class({
	 ...
	 **/
	, patch_detail:co.wrap(function* patch_detail( bundle ){
	 ...
	 **/
	, put_detail: co.wrap(function* put_detail( bundle ){
		...
		bundle = yield this.replace_object( this.bundle(bundle.req, bundle.res, data ) )
