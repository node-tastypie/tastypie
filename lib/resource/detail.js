...
/*jshint laxcomma: true, smarttabs: true, node:true, unused:true, esversion:6 */
'use strict';
/**
...
function delete_db( bundle, err, data ){
	...
	this.full_dehydrate(bundle.object, bundle, function( err, data ){
		if( err ){
...
Detail = new Class({
	...
	delete_detail: function delete_detail( bundle ){
		return this.get_object( bundle, function( err, obj ){
...
var MyResource = new Class({
	...
	, replace_object: function replace_object( bundle, callback ){
		var e = new Boom.notImplemented("method replace_object not implemented");
		e = annotate(e, bundle);
		return callback && callback( e, null );
	}
