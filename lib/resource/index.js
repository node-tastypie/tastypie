...
Resource = new Class({
  ...
  , mixin: [ Options, Parentize, Schema, Detail ]
  , options: {
		name: null
	  , apiname: null
	  , includeUri: true
	 ...
	 * @example
{
	...
	, post_list: function post_list( bundle ){
		...
		this.create_object( bundle, function( err, bndl ){
			if( err ){
	 ...
	 * @method module:tastypie/lib/resource#get_objects
	...
	, get_objects: function get_objects( bundle, callback ){
		var e = new exceptions.NotImplemented( "get_objects is not implemented" );
		e.req = bundle.req;
		e.res = bundle.res;
		callback( e );
	}
	 ...
	 * @protected
	 * @method module:tastypie/lib/resource#create_object
	 * @param {Bundle} bundle A bundle representing the current request
	...
	, create_object: function create_object( bundle, callback ){
		var e = new exceptions.NotImplemented( "create_object is not implemented" );
		e.req = bundle.req;
		e.res = bundle.res;
