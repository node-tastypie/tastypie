...
filterschema = joi.alternatives().try(
	joi.number()
	, joi.array().items( joi.string().valid('gt','gte','in','lt','lte','ne','nin','regex','all', 'active'
											,'size','match','contains','icontains','startswith','exact','iexact', 'isnull',
											'istartswith','endswith','iendswith', 'range', 'pk', 'year', 'month', 'day', 'hour', 'minute') 
	)
);
