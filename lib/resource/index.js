...
var MyResource = new Class({
	...
	,full_dehydrate: function( obj, bundle){
		...
		for( var field in _fields ){
			_field = this.fields[ field ]
			_obj[ field ] = _field.dehydrate( obj )
...
Object.defineProperties( Resource.prototype,{
		...
		get: function( ) {
			...
			return this._uricache.map(function( route ){
				return {
					...
					,validate:that.options[method + '_' + 'validation' ] || that.options.validation || undefined
					}
				};
			});
		}
	 ...
	 * @name urls
	 * @memberof module:tastypie.resources.Resource.urls
	 * @type Array
	 **/
	,urls: {
		get: function( ){
