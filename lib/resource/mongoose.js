...
module.exports = MongoResource = new Class({
	...
	,buildFilters: function buildFilters( qs ){
		var query = new this.options.queryset();
		// FIXME: I don't like all of these params here
		// this helper isn't really a helper at this point...
		return helpers.qs.buildFilters( query.model, qs, this.options.filtering, this.fields );
	}
