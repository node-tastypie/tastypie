...
Serializer = Class({
	...
	,constructor:function( meta ){
		this.setMeta( meta )
		this.formats = {};
		Object.keys( this.meta.content_types ).forEach( function( type ){})
	...
	,serialize:function( data, format, callback ){
		...
		throw new exceptions.UnsuportedFormat( desired_format );
	}

	,convertFormat: function convertFormat( format ){
		var types = this.meta.content_types
	...
	,to_xml: function( data, callback ){
		debug("executing to_xml")
		setTimeout( this.attempt(function(){
			debug("appling to_xml callback %s", jstoxml.toXML( this.to_jstree( data) , {header:true, indent:" "} ))
