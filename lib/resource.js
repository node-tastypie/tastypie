...
Resource = new Class(/** @lends module:tastypie.resource.Resource.prototype */{
	...
	 * @return
	 **/
	,put_list: function put_list( bundle ){
	...
	 * @return
	 **/
	,delete_list: function delete_list( bundle ){
	...
	 * @return
	 **/
	,_put_list: function _put_list( bundle, opts, callback ){
		var e = new exceptions.NotImplemented("_post_list is not implemented")
		e.req = bundle.req
		e.res = bundle.res
		callback( e )
	...
	,full_hydrate: function( bundle ){
		...
		bundle.object = bundle.object || new this.options.objectTpl;
		var attr
		...
		for( var fieldname in this.fields ){
			...
			if( attr){
				...
				bundle.object[ attr ] = field.hydrate( bundle )
			}
