...
Resource = Class({
    ...
    ,get_list: function( bundle ){
		this.serialize({fake:'data'}
		, this.format(bundle.req, this.meta.serializer.types)
		,function( err, data ){
			bundle.serialized = data;
			bundle.data = data;
			http.HttpResponse(bundle.res, bundle)
		})
	}
	/**
	 * DESCRIPTION
